...
An open-source R package with a Shiny interface and code-based tools designed to calculate molecular descriptors, harmonize heterogeneous ADMET datasets from external web servers or local sources, apply drug-likeness filters, predict pharmacokinetic properties such as P-glycoprotein substrates and BOILED-Egg parameters, and generate publication-ready visualizations and automated analysis reports.
...
1. **CDK & webchem** - retrieve SMILES from PubChem and calculate descriptors
   locally.
2. **ADMET Master Manager** - retrieve SMILES from PubChem and harmonization data.
   locally.
3. **Report** - A summary of the ADMET properties
